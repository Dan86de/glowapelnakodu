...
function SpotifyIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 32 32"
      className="h-8 w-8 fill-green-600 group-hover:fill-green-800"
      {...props}
    >
...
function ApplePodcastIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 32 32"
      className="h-8 w-8 fill-purple-600 group-hover:fill-purple-800"
      {...props}
    >
      <path
        fillRule="evenodd"
...
function OvercastIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 32 32"
      className="h-8 w-8 fill-orange-600 group-hover:fill-orange-800"
      {...props}
    >
...
function RSSIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 32 32"
      className="h-8 w-8 fill-zinc-600 group-hover:fill-zinc-800"
      {...props}
    >
      <path
        fillRule="evenodd"
    ...
    <AudioProvider>
      <header className="bg-zinc-50 lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-112 lg:items-start lg:overflow-y-auto xl:w-120">
        <div className="hidden lg:sticky lg:top-0 lg:flex lg:w-16 lg:flex-none lg:items-center lg:whitespace-nowrap lg:py-12 lg:text-sm lg:leading-7 lg:[writing-mode:vertical-rl]">
          ...
          <span className="mt-6 flex gap-6 font-bold text-zinc-900">
        ...
        <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-zinc-200 lg:px-8 lg:py-12 xl:px-12">
          <Link
            href="/"
            className="relative mx-auto block w-48 overflow-hidden rounded-lg bg-zinc-200 shadow-xl shadow-zinc-200 sm:w-64 sm:rounded-xl lg:w-auto lg:rounded-2xl"
            aria-label="Homepage"
          >
            <Image
              className="w-full"
          ...
          <section className="mt-10 lg:mt-12">
            <h2 className="sr-only flex items-center font-mono text-sm font-medium leading-7 text-zinc-900 lg:not-sr-only">
              <TinyWaveFormIcon
                colors={['fill-zinc-400', 'fill-brand']}
                className="h-2.5 w-2.5"
              />
              <span className="ml-2.5">Słuchaj</span>
            </h2>
            <div className="h-px bg-gradient-to-r from-zinc-200/0 via-zinc-200 to-zinc-200/0 lg:hidden" />
            <ul
              role="list"
              className="mt-4 flex justify-center gap-10 text-base font-medium leading-7 text-zinc-700 sm:gap-8 lg:flex-col lg:gap-4"
            >
              {(
                [
                  ['Spotify', SpotifyIcon, '/'],
