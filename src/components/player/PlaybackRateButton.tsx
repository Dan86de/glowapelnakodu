...
export function PlaybackRateButton({ player }: { player: PlayerAPI }) {
  ...
  return (
    <button
      type="button"
      className="relative flex h-6 w-6 items-center justify-center rounded-md text-zinc-500 hover:bg-zinc-100 hover:text-zinc-700 focus:outline-none focus:ring-2 focus:ring-zinc-400 focus:ring-offset-2"
      onClick={() => {
