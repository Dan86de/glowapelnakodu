...
function Thumb(props: {
  ...
  return (
    <div
      className="-tranzinc-x-1/2 absolute top-1/2"
      style={{
  ...
  return (
    ...
    >
      ...
      <div
        ...
        ref={trackRef}
        className="relative w-full bg-zinc-100 md:rounded-full"
      >
        <div
          className={clsx(
      ...
      <div className="hidden items-center gap-2 md:flex">
        ...
        <span className="text-sm leading-6 text-zinc-300" aria-hidden="true">
          /
        </span>
        <span
          className={clsx(
            'hidden rounded-md px-1 py-0.5 font-mono text-sm leading-6 text-zinc-500 md:block',
            state.getThumbMaxValue(0) === 0 && 'opacity-0',
          )}
        >
