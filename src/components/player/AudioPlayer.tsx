...
function formatHumanTime(seconds: number) {
  ...
  return `${h} ${h === 1 ? 'godzina' : 'godzin'}, ${m} ${
    m === 1 ? 'minuta' : 'minut'
  }, ${s} ${s === 1 ? 'sekunda' : 'sekund'}`
}
...
export function AudioPlayer() {
  ...
  return (
    <div className="flex items-center gap-6 bg-white/90 px-4 py-4 shadow shadow-zinc-200/80 ring-1 ring-zinc-900/5 backdrop-blur-sm md:px-6">
